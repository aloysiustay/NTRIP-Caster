...
namespace RtcmSharp.RtcmMessageTypes
{
    ...
    DF418=0
	------------------------------------------------------------------------------*/
    public class Rtcm1095 : BaseMessage
    {
        public DF_002_UINT_12 m_StationID { get; }
        public GALILEO_001_UINT_30 m_EpochTime { get; }
