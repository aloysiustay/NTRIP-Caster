...
namespace RtcmSharp.RtcmMessageTypes
{
	...
	------------------------------------------------------------------------------*/
    public class Rtcm1085 : BaseMessage
    {
        public DF_002_UINT_12 m_StationID { get; }
        public GLONASS_064_UINT_3 m_DayOfWeek { get; }
        public GLONASS_001_UINT_27 m_EpochTime { get; }
        ...
        public Rtcm1085(Bitstream _bitStream)
        {
            m_MessageType = _bitStream.ReadBitsUnsigned(12);
            m_StationID = _bitStream.ReadBitsUnsigned(12);
            m_DayOfWeek = _bitStream.ReadBitsUnsigned(3);
            m_EpochTime = _bitStream.ReadBitsUnsigned(27);
