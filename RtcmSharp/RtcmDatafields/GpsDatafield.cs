...
namespace RtcmSharp.RtcmDataFields
{
    ...
    public class GPS_029_INT_14_S : DataFieldBase<int>
    {
        public GPS_029_INT_14_S(int _rawValue) : base(_rawValue) { }
        public static implicit operator GPS_029_INT_14_S(int _rawValue) => new (_rawValue);
    }
