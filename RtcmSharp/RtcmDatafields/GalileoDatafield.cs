...
namespace RtcmSharp.RtcmDatafields
{
    ...
    [DataField(name: "GALILEO_022", dataType: "UINT", bitLength: 16, scaleFactor: RtcmConstants.P2_29, description: "Galileo Cic")] //DF305
    public class GALILEO_022_UINT_16_S : DataFieldBase<ushort>
    {
        public GALILEO_022_UINT_16_S(ushort _rawValue) : base(_rawValue) { }
        public static implicit operator GALILEO_022_UINT_16_S(ushort _rawValue) => new(_rawValue);
    }

    [DataField(name: "GALILEO_023", dataType: "UINT", bitLength: 32, scaleFactor: RtcmConstants.P2_31, description: "Galileo Ω0")] //DF306
    public class GALILEO_023_UINT_32_S : DataFieldBase<uint>
    {
        public GALILEO_023_UINT_32_S(uint _rawValue) : base(_rawValue) { }
        public static implicit operator GALILEO_023_UINT_32_S(uint _rawValue) => new(_rawValue);
    }

    [DataField(name: "GALILEO_024", dataType: "UINT", bitLength: 16, scaleFactor: RtcmConstants.P2_29, description: "Galileo Cis")] //DF307
    public class GALILEO_024_UINT_16_S : DataFieldBase<ushort>
    {
        public GALILEO_024_UINT_16_S(ushort _rawValue) : base(_rawValue) { }
        public static implicit operator GALILEO_024_UINT_16_S(ushort _rawValue) => new(_rawValue);
    }

    [DataField(name: "GALILEO_025", dataType: "UINT", bitLength: 32, scaleFactor: RtcmConstants.P2_31, description: "Galileo i0")] //DF308
    public class GALILEO_025_UINT_32_S : DataFieldBase<uint>
    {
        public GALILEO_025_UINT_32_S(uint _rawValue) : base(_rawValue) { }
        public static implicit operator GALILEO_025_UINT_32_S(uint _rawValue) => new(_rawValue);
    }

    [DataField(name: "GALILEO_026", dataType: "UINT", bitLength: 16, scaleFactor: RtcmConstants.P2_5, description: "Galileo Crc")] //DF309
    public class GALILEO_026_UINT_16_S : DataFieldBase<ushort>
    {
        public GALILEO_026_UINT_16_S(ushort _rawValue) : base(_rawValue) { }
        public static implicit operator GALILEO_026_UINT_16_S(ushort _rawValue) => new(_rawValue);
    }

    [DataField(name: "GALILEO_027", dataType: "UINT", bitLength: 32, scaleFactor: RtcmConstants.P2_31, description: "Galileo ω (Argument of Perigee)")] //DF310
    public class GALILEO_027_UINT_32_S : DataFieldBase<uint>
    {
        public GALILEO_027_UINT_32_S(uint _rawValue) : base(_rawValue) { }
        public static implicit operator GALILEO_027_UINT_32_S(uint _rawValue) => new(_rawValue);
    }

    [DataField(name: "GALILEO_028", dataType: "UINT", bitLength: 24, scaleFactor: RtcmConstants.P2_43, description: "Galileo ΩDOT")] //DF311
    public class GALILEO_028_UINT_24_S : DataFieldBase<uint>
    {
        public GALILEO_028_UINT_24_S(uint _rawValue) : base(_rawValue) { }
        public static implicit operator GALILEO_028_UINT_24_S(uint _rawValue) => new(_rawValue);
    }

    [DataField(name: "GALILEO_029", dataType: "UINT", bitLength: 10, scaleFactor: RtcmConstants.P2_32, description: "Galileo BGD (E1/E5a)")] //DF312
    public class GALILEO_029_UINT_10_S : DataFieldBase<uint>
    {
        public GALILEO_029_UINT_10_S(uint _rawValue) : base(_rawValue) { }
        public static implicit operator GALILEO_029_UINT_10_S(uint _rawValue) => new(_rawValue);
    }

    [DataField(name: "GALILEO_030", dataType: "UINT", bitLength: 10, scaleFactor: RtcmConstants.P2_32, description: "Galileo BGD E5b/E1")] //DF313
    public class GALILEO_030_UINT_10_S : DataFieldBase<uint>
    {
        public GALILEO_030_UINT_10_S(uint _rawValue) : base(_rawValue) { }
        public static implicit operator GALILEO_030_UINT_10_S(uint _rawValue) => new(_rawValue);
    }
